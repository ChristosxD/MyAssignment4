...
import com.anystreameu.tshirt.algorithmous.QuickSort;
    ...
    public void printTShirtsBySizeColorFabric(int asc, int sortStyle) {
        ...
        switch (sortStyle) {
            case 1:
                 ...
                 QuickSort.quickSort(Custom.getCustom(),0,Custom.getCustom().size()-1,
                                     new TShirtSizeComparator(),asc);
                 printAList(Custom.getCustom());
                 break;
            case 2:
                 QuickSort.quickSort(Custom.getCustom(),0,Custom.getCustom().size()-1,
                                     new TShirtColorComparator(),asc);
                 printAList(Custom.getCustom());
                break;
            case 3:
                 QuickSort.quickSort(Custom.getCustom(),0,Custom.getCustom().size()-1,
                                     new TShirtFabricComparator(),asc);
                 printAList(Custom.getCustom());
                break;
            case 4:
                QuickSort.quickSort(Custom.getCustom(),0,Custom.getCustom().size()-1,
